...
import { HydraulicResults } from "@/lib/hydraulics/open-channel/types";
...
export const Result = memo(function Result({ results, units }: ResultProps) {
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex justify-between items-baseline bg-secondary p-3 rounded-lg">
            ...
            <p className="text-xl font-bold">
              {results.criticalDepth.toFixed(3)}
              <span className="text-sm font-normal text-muted-foreground ml-1">{lengthUnit}</span>
            </p>
          </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex justify-between items-baseline bg-secondary p-3 rounded-lg">
            ...
            <p className="text-xl font-bold">
              {results.freeboard.controlling.toFixed(3)}
              <span className="text-sm font-normal text-muted-foreground ml-1">{lengthUnit}</span>
            </p>
          </div>
          ...
          <div className="flex justify-between items-baseline bg-secondary p-3 rounded-lg">
            ...
            <p className="text-xl font-bold">
              {results.geometry.totalDepth.toFixed(3)}
              <span className="text-sm font-normal text-muted-foreground ml-1">{lengthUnit}</span>
            </p>
          </div>
          ...
          <div className="flex justify-between items-baseline bg-secondary p-3 rounded-lg">
            ...
            <p className="text-xl font-bold">
              {results.geometry.topWidth.toFixed(3)}
              <span className="text-sm font-normal text-muted-foreground ml-1">{lengthUnit}</span>
            </p>
          </div>
          ...
          <div className="flex justify-between items-baseline bg-secondary p-3 rounded-lg">
            ...
            <p className="text-xl font-bold">
              {results.hydraulicProperties.area.toFixed(3)}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="space-y-2">
              ...
              <p className="text-lg font-semibold">
                {results.hydraulicProperties.hydraulicRadius.toFixed(3)} {lengthUnit}
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-lg font-semibold">
                {results.hydraulicProperties.wettedPerimeter.toFixed(3)} {lengthUnit}
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-lg font-semibold">
                {results.hydraulicProperties.hydraulicDepth.toFixed(3)} {lengthUnit}
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-lg font-semibold">
                {results.criticalSlope.toFixed(6)} {slopeUnit}
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-lg font-semibold">
                {results.specificEnergy.toFixed(3)} {lengthUnit}
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-lg font-semibold">
                {results.freeboard.lining.toFixed(3)} {lengthUnit}
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-lg font-semibold">
                {results.freeboard.bank.toFixed(3)} {lengthUnit}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="text-sm text-muted-foreground space-y-1">
              <p>
                ...
                (Fr = {results.froudeNumber.toFixed(3)})
              </p>
              ...
              <p>
                <span className="font-medium">Reynolds Number:</span> {results.reynoldsNumber.toFixed(0)}
